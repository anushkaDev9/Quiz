function check(){
   var total =10;// total question
   var score=0;// user score
   let q1=document.forms["htmlQuiz"]["q1"].value;
   let q2=document.forms["htmlQuiz"]["q2"].value;
   let q3=document.forms["htmlQuiz"]["q3"].value;
   let q4=document.forms["htmlQuiz"]["q4"].value;
   let q5=document.forms["htmlQuiz"]["q5"].value;
   let q6=document.forms["htmlQuiz"]["q6"].value;
   let q7=document.forms["htmlQuiz"]["q7"].value;
   let q8=document.forms["htmlQuiz"]["q8"].value;
   let q9=document.forms["htmlQuiz"]["q9"].value;
   let q10=document.forms["htmlQuiz"]["q10"].value;
   ...
   var answers=['a','d','b','a','c','c','b','a','a','a',]
   for(i=1;i<=total;i++){
